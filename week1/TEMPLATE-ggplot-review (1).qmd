...
ggplot(data = penguins,
       mapping = aes(x = bill_length_mm, y = bill_depth_mm,
                     ...
                     color = species)) +
  geom_point() +
  scale_color_manual(values = c('hotpink','dodgerblue','firebrick'))
```
...
ggplot(penguins, aes(x = bill_length_mm, y = bill_depth_mm, 
                     # Makes a continuous scale
                     color = body_mass_g)) + 
  geom_point() +
  scale_color_gradient(low = "#F7DD4C", high = "#134")
```
...
ggplot()+
  geom_point(data = penguins,
             mapping = aes(x = bill_length_mm, 
                           ...
                           color = species),
             alpha = 0.5) +
  geom_point(data = penguins_summary, mapping = aes(x = mean_bill_length_mm, y = mean_bill_depth_mm, fill = species), 
             size = 5, shape= 24)
```
...
ggplot(penguins, aes(x = flipper_length_mm, fill= species)) +
  ...
  scale_fill_manual(values = c('darkorange','cyan4','firebrick')) +
...
(p1+p2/p3 ) +
  plot_annotation(title= "title for penguins")
