...
drought_clean |> 
  ...
  ggplot(aes(x=date,y = area_pct, fill = drought_lvl_long, na.rm=TRUE)) +
  geom_area()+
  scale_y_continuous(breaks = seq(0, 100, by = 10), labels = scales::label_percent(scale = 1))+
  scale_x_continuous(breaks = seq(2000, 2026, by = 2))+
  scale_fill_manual(values = c("#FFFF04", "#FF0000", "#FFC100", "#853904","#FFE79A")) +
  labs(fill = "none",
