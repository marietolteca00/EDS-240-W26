...
annotation <- glue::glue(
  ...
  including recycling & desalination. Negative availability indicates 
  reliance on groundwater, imported water, or stored reserves."
)
...
water_plot <- ggplot(sbc_subbasin_monthly) +
  ...
  theme(
    plot.title.position = "plot", # Moves title position to the far left
