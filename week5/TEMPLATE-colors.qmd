...
# for qualitative palettes ---- Categorical
cat_color_plot +
...
con_color_plot +
  scale_color_distiller(palette = "BuPu", 
                        # Reverse color order - The highest value now has the darkest color
                        direction = 1)

# for classed continuous color scales ---- Discrete
con_color_plot +
...
ggplot(penguins, aes(x= bill_length_mm, y = bill_depth_mm, fill = body_mass_g)) +
  geom_point(shape = 22, size = 4, alpha = 0.8) + 
...
# Run in console to see colors with hexcodes - pal_d
